    ...
    public function loginStudent(Request $request)
{
    ...
    // Asegurar que esté usando el guard correcto para Spatie
    $persona->guard_name = 'api';
    ...
    // Cargar relaciones explícitamente por si acaso
    $persona->load('roles', 'permissions');
    ...
    return $this->respondWithToken([
        ...
        'user' => [
            'nombre' => $persona->name,
            'ci' => $persona->ci,
            'role' => $persona->getRoleNames(), // devuelve un array de nombres de roles
        ],
        'permissions' => $persona->getAllPermissions()->pluck('name'), // array de permisos
    ]);
}
